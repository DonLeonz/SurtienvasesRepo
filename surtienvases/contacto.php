...
<head>
    ...
    <meta name="description" content="Contáctanos - SurtiEnvases en Neiva, Huila. Dos sedes para servirte mejor" />
    ...
    <title>Contacto - SurtiEnvases</title>
</head>
    ...
    <section class="seccion-fondo-blanco navbar-ajuste-primer-hijo">
        <div class="uk-container">
            ...
            <div class="uk-margin-large-top contenedor-redondeado" style="overflow: hidden">
                <img src="assets/img/surtienvases/imagenes/SurtiImagen (7).jpg" alt="Equipo SurtiEnvases"
                        ...
                        <div class="uk-margin-top">
                            ...
                            <div class="uk-margin-small-top">
                                ...
                                <a href="https://www.instagram.com/envases_surtienvases"
                                    class="uk-icon-button uk-margin-small-left" uk-icon="icon: instagram"
