...
<section class="seccion-fondo-blanco navbar-ajuste-primer-hijo">
    <div class="uk-container">
        ...
        <div class="uk-margin-large-top contenedor-redondeado" style="overflow: hidden">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/surtienvases/imagenes/SurtiImagen (8).jpg"
                alt="Instalaciones SurtiEnvases" class="uk-width-1-1" style="height: 400px; object-fit: cover" uk-img />
        </div>
    </div>
</section>
        ...
        <div class="uk-grid-medium uk-child-width-1-2@m" uk-grid>
            ...
            <div>
                <div class="uk-card uk-card-default uk-card-body uk-card-hover">
                    ...
                    <div class="contenedor-redondeado uk-margin-bottom" style="overflow: hidden">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/surtienvases/imagenes/SurtiImagen (1).jpg"
                            alt="Sede 1 SurtiEnvases" class="uk-width-1-1" style="height: 300px; object-fit: cover"
                            uk-img />
                    </div>
            ...
            <div>
                <div class="uk-card uk-card-default uk-card-body uk-card-hover">
                    <!-- Imagen sede 2 -->
                    <div class="contenedor-redondeado uk-margin-bottom" style="overflow: hidden">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/surtienvases/imagenes/SurtiImagen (19).jpg"
                            alt="Sede 2 SurtiEnvases" class="uk-width-1-1" style="height: 300px; object-fit: cover"
                            uk-img />
                    </div>
