<?php
// catalogo.php - Página de Catálogo
...
<head>
    ...
    <meta name="description" content="Catálogo - SurtiEnvases en Neiva, Huila" />
    ...
    <title>Catálogo - SurtiEnvases</title>
...
<body>
    ...
    <section class="seccion-fondo-blanco navbar-ajuste-primer-hijo">
        <div class="uk-container">
            ...
            <div class="uk-margin-large-top contenedor-redondeado" style="overflow: hidden">
                <img src="assets/img/surtienvases/imagenes/SurtiImagen (9).jpg" alt="Banner de catálogo"
    ...
    <script src="js-php/catalogo-php.js"></script>
</body>
